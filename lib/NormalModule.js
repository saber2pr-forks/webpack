...
class NormalModule extends Module {
	 ...
	 * @param {string} options.resource path + query + fragment of the real resource
	 * @param {string | undefined} options.matchResource path + query + fragment of the matched resource (virtual)
	...
	nameForCondition() {
		...
		return parseResource(resource).path;
	}
